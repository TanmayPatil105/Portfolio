    ...
    render() {
        ...
        <div>
            ...
            <div className='row'>
                ...
                <div className="col-md-4 d-flex justify-content-center align-items-center" style={{marginTop:"30px"}}>
                    <Card title={"Portfolio"} description={"My Portfolio Website"} img={"https://devstickers.com/assets/img/pro/z392.png"} link={"https://github.com/TanmayPatil105/Portfolio"} />
                </div>
            </div>
            <div className="row">
                <div className="col-md-4 d-flex justify-content-center align-items-center" style={{marginTop:"100px"}}>
                    <Card title={"diff"} description={"Git diff command to compare two files line by line"} img={"https://www.kindpng.com/picc/m/403-4039227_c-language-logo-png-transparent-png.png"} link={"https://github.com/TanmayPatil105/diff"} />
                </div>
                <div className="col-md-4 d-flex justify-content-center align-items-center" style={{marginTop:"100px"}}>
                    <Card title={"Resume Maker"} description={"Resume building app using JavaScript"} img={"https://1000logos.net/wp-content/uploads/2020/09/JavaScript-Logo.png"} link={"https://github.com/TanmayPatil105/Resume-Maker"} />
                </div>
                <div className="col-md-4 d-flex justify-content-center align-items-center" style={{marginTop:"100px"}}>
