  ...
  render() {
    return (
        <div className="text-success" style={{fontSize:this.state.matches?"50px":"20px",fontFamily:"'Chakra Petch', sans-serif",backgroundColor: 'blue'}}>
          ...
          <div class='random s'><iframe style={{borderRadius:"12px"}} title="myPlaylist" src="https://open.spotify.com/embed/playlist/47XjpODj1wy8mjrlvbAaWX?utm_source=generator" width={this.state.matches?"100%":"80%"} height={this.state.matches?"152":"120"} frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe></div>
        </div>
    )
  }
}
